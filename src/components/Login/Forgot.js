...
import { Platform, StyleSheet, Text, View, Image, KeyboardAvoidingView, ActivityIndicator, Dimensions, BackHandler } from 'react-native';
                ...
                <View style={styles.container}>
                    <Image
                        style={{
                            ...
                            bottom: -width * 0.35, right: -width * 0.3, opacity: 0.1, transform: [{ rotate: "320deg" }]
                        }}
                    ...
                    <View style={styles.first_container}>
                        ...
                        <KeyboardAvoidingView >
                            <View style={{ marginTop: height * 0.02 }}>
                                <Text style={{ fontSize: width > height ? wp('2%') : wp('3.5%'), position: 'absolute', left: width > height ? wp('33%') : wp('10%'), backgroundColor: 'white', zIndex: 999, top: 5 }}> {Text_EN.Text_en.email} </Text>
                                <TextInput
                                    style={styles.input}
                                    autoCapitalize="none"
                                    returnKeyType="next"
                            ...
                            <View>
                                <LinearGradient colors={['#87d9f7', '#00a1ff']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.log_btn}>
                                    <TouchableOpacity onPress={() => this.login_clicked()}>
                                        <Text style={{ textAlign: 'center', color: 'white', fontSize: width > height ? wp('2%') : wp('4%'), 
                                                    fontWeight: 'bold', borderRadius: 28, paddingTop: 15, paddingBottom: 15 }}>Submit</Text>
                                    </TouchableOpacity>
                                </LinearGradient>

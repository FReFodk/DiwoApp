...
import { Dimensions, StyleSheet, Text, View, ActivityIndicator, TouchableOpacity, Image, StatusBar, ScrollView, Alert, Linking } from 'react-native';
...
export default class home extends Component {
    ...
    renderViewMore = (onPress) => {
        return (
            <Text onPress={onPress} style={{ fontSize: width > height ? wp('2.3%') : wp('3.5%'), color: '#ffff', fontWeight: 'bold', marginTop: 12, textAlign: 'right' }}>{Text_EN.Text_en.View_more}</Text>
        )
    }
    renderViewLess = (onPress) => {
        return (
            <Text onPress={onPress} style={{ fontSize: width > height ? wp('2.3%') : wp('3.5%'), color: '#ffff', fontWeight: 'bold', marginTop: 12, textAlign: 'right' }}>{Text_EN.Text_en.View_less}</Text>
        )
    }
    _renderItem = ({ item, index }) => {
        ...
        return (
            <View style={styles.dynamic_list_view}>
                <Card borderRadius={15} containerStyle={{ marginLeft: 12, backgroundColor: '#00a1ff', width: width > height ? wp('90%') : wp('90%') }}>
                    <View>
                        <ViewMoreText
                            numberOfLines={4}
                            renderViewMore={this.renderViewMore}
                            renderViewLess={this.renderViewLess}
                            textStyle={{ fontSize: width > height ? wp('2%') : wp('3.8%'), textAlign: 'center' }}
                        >
                            <Text style={{ color: 'white', fontSize: width > height ? wp('2%') : wp('4%') }}>{item.experience} {"\n"} {item.date} {"\n"} {item.user_name} </Text>
                        </ViewMoreText>
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
              ...
              <ActivityIndicator size="large" color="#19e600" animating={this.state.loading}/>
                    ...
                    />
                    <View style={{ padding: 8, flexDirection: 'row', borderBottomColor: '#01a2ff', borderBottomWidth: 2, justifyContent: 'space-between' }}>
                        <View>
                        ...
                        <View>
                            <TouchableOpacity onPress={() => this.props.navigation.openDrawer()}>
                                <Image
                                    style={{ width: width > height ? wp('3.5%') : wp('6%'), height: width > height ? wp('3%') : wp('6%') }}
                    ...
                    <View style={{ flex: height * 0.0100, paddingBottom: 10, backgroundColor: 'transparent' }}>
                        <ScrollView>
                            <Card borderRadius={15}>
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ flex: 0.2, justifyContent: 'center', alignItems: 'center' }}>
                                        ...
                                        />
                                        {this.state.message_active == 1 ? <View style={styles.indicator}><Text></Text></View> : null}
                                    </View>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center' }}>
                                    <View style={{ flex: 0.2, justifyContent: 'center', alignItems: 'center' }}>
                                        <Image
                                            ...
                                            source={require('../../uploads/diamond_img.png')}
                                        />
                                        {this.state.isWorkjoy_active == 1 ? <View style={styles.indicator}><Text></Text></View> : null}
                                    </View>
                                    <View style={styles.question_card_text}>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ flex: 0.2, justifyContent: 'center', alignItems: 'center' }}>
                                        <Image
                                            ...
                                            source={require('../../uploads/diamond_img.png')}
                                        />
                                        {this.state.isSocialKapital_active == 1 ? <View style={styles.kapitalIndicator}><Text></Text></View> : null}
                                    </View>
                                    <View style={styles.question_card_text}>
                ...
                <View style={styles.bottom_btn}>
                    ...
                    <HideWithKeyboard>
                        <View style={{ marginBottom: 0 }}>
                            ...
                            <Text style={{ textAlign: 'center', marginBottom: 0 }}><Text style={{ fontSize: 18 }}>©</Text> Copyright FReFo</Text>
                        </View>
                    </HideWithKeyboard>
                </View>
            </SafeAreaView>
